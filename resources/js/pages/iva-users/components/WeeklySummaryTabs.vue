...
import WeeklySummaryCategoryBreakdown from './WeeklySummaryCategoryBreakdown.vue';
...
const tabs = computed(() => [
  ...
  { key: 'weekly', title: 'Weekly Breakdown', icon: 'ri-calendar-week-line' },
        ...
        <VCard>
          <VCardText>
            <div class="d-flex justify-space-between align-center mb-4">
              <h3 class="text-h6 font-weight-medium">Weekly Hours Chart</h3>
              ...
              <div ref="chartContainer" class="chart-wrapper" :style="{
                ...
                <div class="chart-grid" :style="{
                  ...
                  <div class="d-flex align-end chart-bars" :style="{
                    ...
                    <div v-for="week in chartData" :key="`${week.week_year}-${week.week_number}`"
                      ...
                      <div class="bar-stack" :style="{
                        ...
                        <div v-if="week.billable > 0" class="bar-segment billable-bar" :style="{
                          height: `${(week.billable / maxHours) * (chartSettings.chartHeight - 60)}px`,
                        ...
                        <div v-if="week.nonBillable > 0" class="bar-segment non-billable-bar" :style="{
                          height: `${(week.nonBillable / maxHours) * (chartSettings.chartHeight - 60)}px`,
                        ...
                        <div v-if="week.nad > 0" class="bar-segment nad-bar" :style="{
                          height: `${(week.nad / maxHours) * (chartSettings.chartHeight - 60)}px`,
                      ...
                      <!-- Week Label -->
                      <div class="week-info text-center" :style="{
                        position: 'absolute',
...
"></div>
      ...
      <VWindowItem value="weekly">
        <WeeklySummaryBreakdown :weekly-breakdown="summaryData?.weekly_breakdown || []" :is-mobile="isMobile" />
      </VWindowItem>

      <!-- Categories Tab -->
      <VWindowItem value="categories">
        <WeeklySummaryCategoryBreakdown :category-breakdown="summaryData?.category_breakdown || []"
          :is-mobile="isMobile" />
      </VWindowItem>
