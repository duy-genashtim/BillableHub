    ...
    <VCard>
      <VCardText>
        <div class="d-flex flex-wrap align-center mb-6">
          ...
          <VBtn v-if="authStore.hasPermission('edit_iva_data')" color="primary" prepend-icon="ri-add-line" :size="isMobile ? 'small' : 'default'" @click="addNewRegion">
        ...
        <VDataTable :headers="headers" :items="regions" :loading="loading" :sort-by="sortBy" density="comfortable" hover
            ...
            <div class="d-flex justify-end">
              ...
              <VMenu v-if="isMobile">
                ...
                <VList density="compact">
                  ...
                  <VListItem v-if="authStore.hasPermission('edit_iva_data')" @click="editRegion(item)">
                    <template v-slot:prepend>
          ...
          <template #no-data>
            <div class="d-flex flex-column align-center pa-6">
              ...
              <VBtn v-if="authStore.hasPermission('edit_iva_data')" color="primary" @click="addNewRegion">
                Add New Region
              </VBtn>
            </div>
          </template>
